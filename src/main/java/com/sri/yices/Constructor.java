...
public enum Constructor {
    ...
    ARITH_FF_CONSTANT(2),    // finite field rational constant
    ...
    ARITH_FF_SUM(43),        // sum of pairs a * t where a is an finite field constant (and t is an finite field arithmetic term)
